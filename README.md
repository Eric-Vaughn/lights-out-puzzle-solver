...
I WILL NOT be generating the code for my application. Instead, at the end of this project, I will generate the application in its totality and compare differences with my code and what is generated.
